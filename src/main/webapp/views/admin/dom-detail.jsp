...
<div id="content-body" class="content-body pl-328">
    <div class="container-fluid my-container">
        ...
        <div style="margin-top: 15px">
                                ...
                                <td>
                                    <div class="flex justify-center">
                                        <div class="btn-action" style="width: fit-content;">
                                            <a href="<%=request.getContextPath()%>/admin/room-detail?roomName=${bed.roomName}">Detail</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
            ...
            <button onclick="location.href='<%=request.getContextPath()%>/admin/dorm';return false;" class="SAB-back"
